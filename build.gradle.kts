...
val metadata =
    ModMetadata(
        name = "leaderboard",
        displayName = "LeaderboardPlugin",
        author = "xpdustry",
        description = "A simple leaderboard system for players.",
        version = "4.0.0",
        minGameVersion = "146",
        hidden = true,
        java = true,
        main = "com.xpdustry.leaderboard.LeaderboardPlugin",
        repo = "xpdustry/leaderboard",
...
group = "com.xpdustry"
val rootPackage = "com.xpdustry.leaderboard"
...
repositories {
    ...
    // This repository provides xpdustry libraries from the old repository
